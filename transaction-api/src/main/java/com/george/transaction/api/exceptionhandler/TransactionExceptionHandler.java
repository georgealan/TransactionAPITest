...
public class TransactionExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest request) {
        ...
        /*Não precisamos utilizar o ex.getCause() porque o EmptyResultDataAccessException é uma excessão em si e não
        pode ser capturada pelo getCause(), se não vai dar erro.*/
